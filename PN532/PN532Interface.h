...
#define PN532_READ_WAIT_TIME          (1000)  // ms, timeout of waiting for READ
...
public:
    ...
    */
    virtual int16_t readResponse(uint8_t buf[], uint8_t len, uint16_t timeout = PN532_READ_WAIT_TIME) = 0;
};
